...
public class ProductController {
    ...
    @ApiOperation(value = "This API endpoint retrieves a product based on id", httpMethod = "GET")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Ok", response = GenericProductDto.class),
    ...
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "OK", response = GenericProductDto.class, responseContainer = "List"),
            @ApiResponse(code = 500, message = "Internal server error", response = ExceptionDto.class)
    })
    @GetMapping("/all")
    ...
    @ApiOperation(value = "This API endpoint retrieves a list of products from the system based on the specified limit", httpMethod = "GET")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Ok", responseContainer = "List", response = GenericProductDto.class),
            @ApiResponse(code = 400, message = "Bad Request", response = ExceptionDto.class),
            @ApiResponse(code = 500, message = "Internal server error", response = ExceptionDto.class),
            @ApiResponse(code = 404, message = "No products found", response = ExceptionDto.class)
    })
    @GetMapping("")
    ...
    @ApiOperation(value = "This API endpoint retrieves a comprehensive list of all categories available within the product system", httpMethod = "GET")
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "This API endpoint retrieves a list of products that belong to a specific category within the system", httpMethod = "GET")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Ok", responseContainer = "List", response = GenericProductDto.class),
            @ApiResponse(code = 400, message = "Category not found", response = ExceptionDto.class),
            @ApiResponse(code = 404, message = "No products found for the given category", response = ExceptionDto.class),
            @ApiResponse(code = 500, message = "Internal server error", response = ExceptionDto.class)
    })
    ...
    @ApiOperation(value = "This API endpoint creates new product in the system",httpMethod = "POST")
    @ApiResponses(value = {
            @ApiResponse(code = 201,message = "Product created",response = GenericProductDto.class),
            @ApiResponse(code = 400,message = "Invalid argument", response = ExceptionDto.class),
            @ApiResponse(code = 500, message = "Internal server error", response = ExceptionDto.class)
    })
    @PostMapping("/add")
    ...
    @ApiOperation(value = "This API endpoint updates an existing product based on id",httpMethod = "PUT")
    @ApiResponses(value = {
            @ApiResponse(code = 200,message = "Product updated", response = GenericProductDto.class),
            @ApiResponse(code = 500,message = "Internal server error", response = ExceptionDto.class)
    })
    @PutMapping("/{id}")
    ...
    @ApiOperation(value = "This API endpoint deletes an existing product based on id", httpMethod = "DELETE")
    @ApiResponses(value = {
            @ApiResponse(code = 200,message = "Product deleted successfully", response = GenericProductDto.class),
            @ApiResponse(code = 404, message = "Product not found", response = ExceptionDto.class),
            @ApiResponse(code = 500, message = "Internal server error", response = ExceptionDto.class)
    })
    @DeleteMapping("/{id}")
